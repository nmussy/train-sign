...
import {isQuadrilingualName} from '../../../util/sign';
...
export const JREastSign: FunctionalComponent<SignProperties> = ({sign}) => (
  <div class={style.sign}>
    <div class={style.topContainer}>
      ...
      <div class={style.topOffsetNameContainer}>
        {isQuadrilingualName(sign.name) && sign.name.kanji.length < 7 ? (
          <Fragment>
